//! This module contains CPUID definitions with leaves in the range reserved for hypervisors (0x4000_0000, 0x4FFF_FFFF).

use std::ops::RangeInclusive;

use crate::x86_64::CpuidReg;
use crate::x86_64::cpuid_definitions::{
    CpuidDefinitions, MigrationCompatibilityRequirement, Parameters, ProfilePolicy,
    ...
    CpuidDefinitions([
        ...
        (
            ...
            ValueDefinitions::new(&[ValueDefinition {
                ...
                migration_compatibility_req: MigrationCompatibilityRequirement::GtEq,
            }]),
        ),
        (
            Parameters {
